...
from models.hn_ppisp import HNPPISP
...
def train(class_tag, model, train_data_set, save, n_epochs=3,
    ...
    # Start log
    with open(os.path.join(save, 'HNPPISP_results.csv'), 'w') as f:
        ...
        for epoch in range(n_epochs):
            ...
            if f_max > best_F:
                ...
                torch.save(model.state_dict(), os.path.join(save, 'HNPPISP_model.dat'))
            else:
                count += 1
                if count >= 5:
                    return None
